...
if __name__ == "__main__":
    ...
    print("\nSorted by first element (default):")
for t in sorted(tuples_list):
    print(t)

print("\nSorted by second element (float):")
for t in sorted(tuples_list, key=lambda x: x[1]):
    print(t)

print("\nSorted by third element (string):")
for t in sorted(tuples_list, key=lambda x: x[2]):
    print(t)
